import { User, Photo, ROLE, CreateUser, UpdateUser } from '@/types'
...
export class UserServices {
  ...
  async getAllUsers(page: number, pageSize: number = 5, isActive: boolean = true): Promise<{ users: User[], total: number }> {
